...
export default function NotableRoles() {
  return (
    <div className="notable-stuff mb-8">
      ...
      <ul>
      <a className='server' href="https://discord.gg/ntts"><img width="32" height="32" src="https://cdn.discordapp.com/icons/820745488231301210/a_6246f067aafbe431354103982e7e4099.gif?size=1024&width=0&height=320"></img><span className="server-tooltip">Mod @ NTTS (100k)</span> </a>
